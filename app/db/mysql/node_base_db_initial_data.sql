...
INSERT INTO `user` (`id`, `username`, `password`, `type`, `verified`, `create_date`, `last_login`) VALUES (1000000,'armenzakary@gmail.com','$2a$10$08oC45BIxg.nHBNN/9lYzudpYYSecgDZNWkj99oySvSl6.LxPJGrC','CLIENT',1, NULL, NULL);
INSERT INTO `client` (`user_id`, `client_specific_data`) VALUES (1000000, "Some Client Specific DATA");
...
-- -----------------------------------------------------
INSERT INTO `user` (`id`, `username`, `password`, `type`, `verified`, `create_date`, `last_login`) VALUES (1000002,'jone0089@gmail.com','$2a$10$08oC45BIxg.nHBNN/9lYzudpYYSecgDZNWkj99oySvSl6.LxPJGrC','ADMIN',1, NULL, NULL);
